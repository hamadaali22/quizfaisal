      ...
      <div class="col-lg m-auto">
          ...
          <div class="row">
            <div class="col-4">
             ...
             <div class="col-5">
                 <img :src="'https://deutschtests.com/img/telc/'+getLevelDesc.level_images[0].name" class="img-fluid w-100" :alt="getLevelDesc.level_images[0]['alt_' + $i18n.locale]">
             </div>
          ...
          <div class="row">
            <div class="col-4">
             ...
             <div class="col-5">
                 <img  :src="'https://deutschtests.com/img/telc/'+getLevelDesc.level_images[1].name" class="img-fluid w-100" :alt="getLevelDesc.level_images[1]['alt_' + $i18n.locale]">
             </div>
             
          </div>
          <div class="row">
            <div class="col-2">
                 <img  :src="'https://deutschtests.com/img/telc/'+getLevelDesc.level_images[4].name" class="img-fluid w-100" :alt="getLevelDesc.level_images[4]['alt_' + $i18n.locale]">
             </div>
            <div class="col-2">
              <img  :src="'https://deutschtests.com/img/telc/'+getLevelDesc.level_images[3].name" class="img-fluid w-100" :alt="getLevelDesc.level_images[3]['alt_' + $i18n.locale]">
            </div>
             ...
             <div class="col-3">
                 <img  :src="'https://deutschtests.com/img/telc/'+getLevelDesc.level_images[2].name" class="img-fluid w-100" :alt="getLevelDesc.level_images[2]['alt_' + $i18n.locale]+'lll'">
             </div>
