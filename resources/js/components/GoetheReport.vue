                  ...
                  <div v-if="SubQuestions.is_multy == 'text'" class="mcq p-3 " v-bind:class="[SubQuestions.color == 'b'  ? 'bg-information' : '']">
                      <div class="answers">
                        <ul class="multi-choice list-unstyled">
                          ...
                          <li class="multi-item q-1 border border-raduis pt-2 pl-3 mb-1" :id="'subq'+index+'a'" v-on:click="dissapear(index,item.exam_id,SubQuestions.question_id,SubQuestions.id,SubQuestions.expected_answer,SubQuestions.first_choice,'subq'+index+'a','a',SubQuestions.answer_type)"  >
                          ...
                          <li class="multi-item q-1 border border-raduis pt-2 pl-3 mb-1" :id="'subq'+index+'b'" v-on:click="dissapear(index,item.exam_id,SubQuestions.question_id,SubQuestions.id,SubQuestions.expected_answer,SubQuestions.second_choice,'subq'+index+'b','b',SubQuestions.answer_type)" >
                          ...
                          <li class="multi-item q-1 border border-raduis pt-2 pl-3 mb-1" :id="'subq'+index+'c'" v-on:click="dissapear(index,item.exam_id,SubQuestions.question_id,SubQuestions.id,SubQuestions.expected_answer,SubQuestions.third_choice,'subq'+index+'c','c',SubQuestions.answer_type)" >
  ...
  import swal from "sweetalert";
    export default {
      ...
      mounted(){
        // let {examId} = this;
        // this.scrollToTop();
        this.$store.dispatch('getGoetheReportExams', { examId: this.examId,pageId:this.pageId });
      },
