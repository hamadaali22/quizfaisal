                ...
                <div class="row">
                    ...
                    <!-- <div v-for="(_item, itemIndex) in goetheUserExams" class="col-lg-12 col-md-12">
                        <div class=" col-lg-2 col-md-12">
                            <div class="our-skill   w-100 text-center text-light mt-1 pt-2 pb-2"
                                ...
                                <router-link v-if="isLogged" :to="'/goethe-report/' + _item.id" class="a-link">{{
                        _item.name }}</router-link>
                            </div>
                        </div>
                        <div class="col-lg-2 col-md-12">
                            <div class="our-skill">
                        ...
                        <div class="col-lg-2 col-md-12">
                            <div class="progress1">
                                ...
                                <div class="progress__fill"
                                    :style="{ background: '#3aa6d0', width: _item.count_read_percent + '%' }"></div>
                    ...
                    <div v-for="(item, itemIndex) in sortedTelcUserExams"  :key="itemIndex"  class="col-lg-12 col-md-12">
                        <div class=" col-lg-2 col-md-12">
                            <div class="our-skill   w-100 text-center text-light mt-1 pt-2 pb-2"
                                style="background-color: #3d83b3;border-radius: 5px;margin-top: -9px !important;    margin-bottom:16px !important;">
                                <router-link v-if="isLogged" :to="'/goethe-report/' + item.id" class="a-link">{{
                        ...
                        <div class="col-lg-2 col-md-12">
                            <div class="progress1">
                                <input type="hidden" value="88" id="progress1" />
                                <div class="progress__fill"
                                    :style="{ background: '#3aa6d0', width: item.count_read_percent + '%' }"></div>
                        ...
                        <div class="col-lg-2 col-md-12">
                            <div class="progress2">
                                <input type="hidden" value="66" id="progress2" />
                                <div class="progress__fill"
                                    :style="{ background: '#3aa6d0', width: item.count_listen_percent + '%' }"></div>
...
export default {
    ...
    computed: {
        ...
        sortedTelcUserExams() {
            return [...this.telcUserExams].sort((a, b) => {
