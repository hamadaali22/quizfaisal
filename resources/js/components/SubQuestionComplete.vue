    ...
    <div class="mcq mt-5">
      ...
      <ul class="multi-choice list-unstyled p-2">
        ...
        <li class="multi-item q-9 border border-raduis pt-2 pl-3 mb-1">
          ...
          <label class="multi-label" for="img-1" id="mars">A.<img src="front.img.jpg" class="img-fluid multi-label-img" alt=""></label>
        </li>
        <li class="multi-item q-9 border border-raduis pt-2 pl-3 mb-1">
          <input class=" multi-input d-none" type="radio" name="q-9" value="jupiter" id="img-2">
          <label class="multi-label" for="img-2" id="jupiter">B.<img src="front.img.jpg" class="img-fluid  multi-label-img" alt=""></label>
        </li>
        <li class="multi-item q-9 border border-raduis pt-2 pl-3 mb-1">
          <input class=" multi-input d-none" type="radio" name="q-9" value="venus" id="img-3">
          <label class="multi-label" for="img-3" id="venus">C.<img src="front.img.jpg" class="img-fluid  multi-label-img" alt=""></label>
        </li>
        <li class="multi-item q-9 border border-raduis pt-2 pl-3 mb-1">
          <input class=" multi-input d-none" type="radio" name="q-9" value="saturn" id="img-4">
          <label class="multi-label" for="img-4" id="saturn">D.<img src="front.img.jpg" class="img-fluid multi-label-img" alt=""></label>
        </li>
      </ul>
    </div>
  </div>
