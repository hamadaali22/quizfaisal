              ...
              <div v-if="SubQuestions.is_multy == 'text'" class="mcq p-3 "
                ...
                <div class="answers">
                  <ul class="multi-choice list-unstyled">
                    ...
                    <h6 v-if="SubQuestions.exam_answer != null">{{ SubQuestions.exam_answer.answer }} -
                      {{ SubQuestions.expected_answer }} </h6>

                    <li class="multi-item q-1 border border-raduis pt-2 pl-3 mb-1"
                      v-if="SubQuestions.exam_answer == null" :id="'subq' + index + 'a'"
                    ...
                    <li class="multi-item q-1 border border-raduis pt-2 pl-3 mb-1"
                      v-else="SubQuestions.exam_answer !=null"
                      :style="SubQuestions.first_choice == SubQuestions.exam_answer.expected_answer
                        && SubQuestions.first_choice == SubQuestions.exam_answer.answer ? 'background: #28D094' : '',
                    ...
                    <li class="multi-item q-1 border border-raduis pt-2 pl-3 mb-1"
                      v-if="SubQuestions.exam_answer != null"
                      :style="SubQuestions.third_choice == SubQuestions.exam_answer.expected_answer
