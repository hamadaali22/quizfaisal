...
@section('content')	
		...
		<div class="content-header row">
			        <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
			          <h3 class="content-header-title mb-0 d-inline-block">الإستشاريين</h3><br>
			          <div class="row breadcrumbs-top d-inline-block">
			            <div class="breadcrumb-wrapper col-12">
			              <ol class="breadcrumb">
			                ...
			                <li class="breadcrumb-item active">الإستشاريين
			                </li>
			              </ol> 
			            </div>
			          </div>
                    ...
                    <div class="card-body">
						<div class="table-responsive">
		                    <table class="table table-striped table-bordered keytable-integration">
		                        <thead>
									<tr>													
										<th class="text-center">اسم الإستشاري </th>
										<th class="text-center">العمليات</th>
									</tr>
								</thead>
								<tbody>
									@foreach ($advisors as $_item)
									<tr>													
										<td class="text-center">
											<a href="{{url('admin/advisor-profile/'.$_item->id) }}">{{ $_item->name }}</a>
										</td>
										<td class="text-center">
										<div class="actions">
											...
											<!-- <a class="btn btn-sm bg-success-light" href="{{ url('admin/instructors/'.$_item->id).'/edit' }}"><i class="fe fe-pencil"></i> تعديل</a>-->
