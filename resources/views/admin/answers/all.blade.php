              ...
              <div class="card">
                ...
                <div class="card-body card-dashboard">
                    ...
                    <table class="table table-striped table-bordered keytable-integration">
                        ...
                        <tbody>                     
                            @foreach ($answers as $_item)
                            <tr>
                                <td>
                                    {{ $_item->name }} 
                                </td>    
                                <td>
                                    {{ $_item->subquestion->title }} 
                                </td>       
                ...
                <div class="modal-dialog modal-dialog-centered" role="document" >
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{route('answers.store')}}" method="POST" name="le_form"  enctype="multipart/form-data">
                  @csrf
                                <div class="row form-row">
                                    ...
                                    <div class="col-12 col-sm-6">
                                        <div class="form-group">
                                            <label>Select Subquestions </label>
                                            <select name="subquestion_id" required class="form-control formselect" >
                                                 <option    disabled>Select</option>
                                                @foreach ($subquestions as $_item)
                                                    <option value="{{$_item->id}}" {{ old('subquestion_id') == $_item->id ? "selected" : "" }}>{{$_item->title}}
                                                    </option>
                                                @endforeach
                                            </select>
                                            @error('subquestion_id')
                                                            ...
                                                            <div class="modal-body">
                                                                <div class="form-content p-2">
                                                                    ...
                                                                    <div class="row text-center">
                                                                        ...
                                                                        <div class="col-sm-2">
                                                                            <form method="post" action="{{route('answers.destroy','test')}}">
                                                                                 @csrf
                                                                                 @method('delete')
