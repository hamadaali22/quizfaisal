...
<div class="content-header row">
    <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
        <h3 class="content-header-title mb-0 d-inline-block">Add exercise </h3><br>
...
<section id="basic-form-layouts">
            ...
            <div class="card">
                ...
                <div class="card-content collpase show">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('exercises.store')}}" method="POST" name="le_form"
                            ...
                            <div class="row form-row">
                                ...
                                <div class="form-group col-md-4 col-sm-4">
                                    ...
                                    <select name="type" class="form-control formselect" id="typeid">
                                        <option value="" selected>Select</option>
                                        <option value="listening" {{ old('type')=='listening' ? "selected" : "" }}>
                                            listening</option>
                                        <option value="listening and image" {{ old('type')=='listening and image'
                                            ? "selected" : "" }}>
                                            listening and image</option>
                                        <option value="reading" {{ old('type')=='reading' ? "selected" : "" }}>reading
                                        </option>
                                ...
                                <div class="form-group col-md-12 col-sm-6 paragraph-hidden">
                                    ...
                                    <textarea name="paragraph" cols="20" rows="1" class="form-control ckeditor"
                                        id='paragraphid'>{{old('paragraph')}}</textarea>
                                    @error('paragraph')
                                    <span class="text-danger">{{$message}}</span>
                                    @enderror
                                ...
                                <div class="row form-row education-cont"
                                    ...
                                    <div class="row form-row col-md-12">
                                        <div class="form-group col-md-4 col-sm-6">
                                            ...
                                            <select name="answer_type[]" class="form-control formselect answerTypeId"
                                                id="answerType1"
                                        ...
                                        <div class="form-group col-md-4 col-sm-6 is_complete_hidden1"
                                            id="is_complete_hidden1">
                                            <label> Select number or Word </label>
                                            <select name="is_complete[]" class="form-control formselect"
                                                id="isComplete1"
 ...
 -->
                                        ...
                                        <div class="col-md-4 col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="expected_answer[]"
                                                    class="form-control expectedAnswerId">
                                                <span id="expectedAnswerError" style="color: red;"></span>
                                            </div>
                                        </div>
                                        <div class="form-group col-md-6 col-sm-6 ">
                                            <label>upload bannar </label>
                                            <input type="file" name="banner[]" id="bannerid" class="form-control"
                                                accept=".JPEG,.JPG,.TIF,.TIFF">
                                            @error('banner')
                                            <span class="text-danger">{{$message}}</span>
                                            @enderror
                            ...
                            <div class="col-md-2">
                                <a href="#Save-btn-scroll" onclick="addVideo()" class="btn btn-primary ">Add
                                    Subquestions</a>
                            </div>
