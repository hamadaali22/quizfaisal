              ...
              <div class="row form-row">
                <div class="col-md-4">
                  <div class="form-group">
                    ...
                    <select name="level_id" required class="form-control formselect">
                      ...
                      <option value="{{$_item->id}}" {{ $exercise->level_id == $_item->id ? "selected" : ""
                        }}>{{$_item->name}}
                      </option>
                      @endforeach
                    </select>
                ...
                <div class="form-group col-md-4 col-sm-6">
                  ...
                  <select name="type" class="form-control formselect" id="typeid">
                    ...
                    <option value="listening" {{ $exercise->type == 'listening' ? "selected" : "" }}>listening</option>
                    <option value="listening and image" {{ $exercise->type == 'listening and image' ? "selected" : ""
                      }}>listening and image</option>
                    <option value="reading" {{ $exercise->type == 'reading' ? "selected" : "" }}>reading</option>
                    <option value="image" {{ $exercise->type == 'image' ? "selected" : "" }}>image</option>
                    <option value="sub" {{ $exercise->type == 'sub' ? "selected" : "" }}>sub</option>
                    <!-- <option value="sub" {{ $exercise->type == 'exercise' ? "selected" : "" }}>Exercise</option> -->
                ...
                <div class="form-group col-md-12 col-sm-6 file-hidden">
                  <audio controls class="align-items-center w-50">
                    <source src="{{asset('img/questions-file/'.$exercise->file) }}" type="audio/ogg">
                    <source src="{{asset('img/questions-file/'.$exercise->file) }}" type="audio/mpeg">
                ...
                <div class="form-group col-md-12 col-sm-6 image-hidden">
                  <img class="avatar-img" src="{{asset('img/questions-image/'.$exercise->image) }}" width="90px">
                ...
                <div class="form-group col-md-12 col-sm-6 paragraph-hidden">
                  ...
                  <textarea name="paragraph" cols="20" rows="1" class="form-control ckeditor"
                    id='paragraphid'>{{$exercise->paragraph}}</textarea>
                  @error('paragraph')
                  <span class="text-danger">{{$message}}</span>
                  @enderror
                ...
                <div class="form-group col-md-12 col-sm-6 paragraph-hidden">
                  ...
                  <textarea name="paragraph_ar" cols="20" rows="1" class="form-control ckeditor"
                    id='paragraphid'>{{$exercise->paragraph_ar}}</textarea>
                  @error('paragraph')
                  <span class="text-danger">{{$message}}</span>
                  @enderror
                  <span id="short_detailError" style="color: red;"></span>
                ...
                <div class="form-group col-md-12 col-sm-6 paragraph-hidden">
                  ...
                  <textarea name="paragraph_en" cols="20" rows="1" class="form-control ckeditor"
                    id='paragraphid'>{{$exercise->paragraph_en}}</textarea>
                  @error('paragraph')
                  <span class="text-danger">{{$message}}</span>
                  @enderror
                  <span id="short_detailError" style="color: red;"></span>
                ...
                <div class="form-group col-md-12 col-sm-6 paragraph-hidden">
                  ...
                  <textarea name="paragraph_fr" cols="20" rows="1" class="form-control ckeditor"
                    id='paragraphid'>{{$exercise->paragraph_fr}}</textarea>
                  @error('paragraph')
                  <span class="text-danger">{{$message}}</span>
                  @enderror
                  <span id="short_detailError" style="color: red;"></span>
                ...
                <div class="form-group col-md-12 col-sm-6 paragraph-hidden">
                  ...
                  <textarea name="paragraph_es" cols="20" rows="1" class="form-control ckeditor"
                    id='paragraphid'>{{$exercise->paragraph_es}}</textarea>
                  @error('paragraph')
                  <span class="text-danger">{{$message}}</span>
                  @enderror
                  <span id="short_detailError" style="color: red;"></span>
                ...
                <div class="form-group col-md-12 col-sm-6 ">
                  ...
                  <textarea name="bio" cols="20" rows="1" class="form-control ckeditor"
                    id='bioId'>{{$exercise->bio}}</textarea>
                  @error('bio')
                  <span class="text-danger">{{$message}}</span>
                  @enderror
                ...
                <div class="form-group col-md-12 col-sm-6 ">
                  ...
                  <textarea name="bio_ar" cols="20" rows="1" class="form-control ckeditor"
                    id='bioId'>{{$exercise->bio_ar}}</textarea>
                  @error('bio')
                  <span class="text-danger">{{$message}}</span>
                  @enderror
                  <span id="bioError" style="color: red;"></span>
                ...
                <div class="form-group col-md-12 col-sm-6 ">
                  ...
                  <textarea name="bio_en" cols="20" rows="1" class="form-control ckeditor"
                    id='bioId'>{{$exercise->bio_en}}</textarea>
                  @error('bio')
                  <span class="text-danger">{{$message}}</span>
                  @enderror
                  <span id="bioError" style="color: red;"></span>
                ...
                <div class="form-group col-md-12 col-sm-6 ">
                  ...
                  <textarea name="bio_fr" cols="20" rows="1" class="form-control ckeditor"
                    id='bioId'>{{$exercise->bio_fr}}</textarea>
                  @error('bio')
                  <span class="text-danger">{{$message}}</span>
                  @enderror
                  <span id="bioError" style="color: red;"></span>
                ...
                <div class="form-group col-md-12 col-sm-6 ">
                  ...
                  <textarea name="bio_es" cols="20" rows="1" class="form-control ckeditor"
                    id='bioId'>{{$exercise->bio_es}}</textarea>
                  @error('bio')
                  <span class="text-danger">{{$message}}</span>
                  @enderror
                  <span id="bioError" style="color: red;"></span>
