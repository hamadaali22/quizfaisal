...
<div class="content-header row">
                    <div class="content-header-left col-md-6 col-12 mb-2 breadcrumb-new">
                      <h3 class="content-header-title mb-0 d-inline-block">إرسال إشعارات للمدربين</h3><br>
                  ...
                  <div class="card-body card-dashboard">
                    <div class="card-body">
                        <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2" 
                                 action="{{route('instructor-send-notifaction')}}" method="POST">
                            @csrf
                            <div class="row form-row">
                                ...
                                <div class="col-md-6" >
                                    <div class="form-group">
                                        ...
                                        <select name="userId[]" required class="select2 form-control" multiple="multiple">
                    ...
                    <div class="card-body">
                         <form class="parsley-style-1" id="selectForm2" autocomplete="off" name="selectForm2" 
                                ...
                                <div class="col-12 col-sm-6">
                                    <div class="form-group">
                                        <label class="form-label">تحديد مدرب او مجموعه او او الكل </label>
                                        <select name="userId[]" required multiple id="select-beast" class="form-control  nice-select  custom-select">
                                         @foreach ($instructors as $_item)
                                                            <option value="{{$_item->id}}">
                                                                 {{$_item->name  }}  
                                                            </option>
