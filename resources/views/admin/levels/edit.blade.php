            ...
            <form method="post" action=" {{route('levels.update',$level->id)}}" enctype="multipart/form-data">
              ...
              <div class="row form-row">
                ...
                <div class="form-group col-md-12 col-sm-6 paragraph-hidden">
                  ...
                  <textarea name="description_ar" cols="20" rows="2" class="form-control ckeditor"
                    id='descriptionId'>{{$level->description_ar}}</textarea>
                </div>
                <div class="form-group col-md-12 col-sm-6 paragraph-hidden">
                  <label>description en</label>
                  <textarea name="description_en" cols="20" rows="2" class="form-control ckeditor"
                    id='descriptionId'>{{$level->description_en}}</textarea>
                </div>
                <div class="form-group col-md-12 col-sm-6 paragraph-hidden">
                  <label>description fr</label>
                  <textarea name="description_fr" cols="20" rows="2" class="form-control ckeditor"
                    id='descriptionId'>{{$level->description_fr}}</textarea>
                </div>
                <div class="form-group col-md-12 col-sm-6 paragraph-hidden">
                  <label>description es</label>
                  <textarea name="description_es" cols="20" rows="2" class="form-control ckeditor"
                    id='descriptionId'>{{$level->description_es}}</textarea>
                </div>
                ...
                <div class="form-group col-md-12 col-sm-6 paragraph-hidden">
                  ...
                  <textarea name="description_telc" cols="20" rows="2" class="form-control ckeditor"
                    id='descriptionId'>{{$level->description_telc}}</textarea>
                </div>
                <div class="form-group col-md-12 col-sm-6 paragraph-hidden">
                  <label>description telc ar</label>
                  <textarea name="description_telc_ar" cols="20" rows="2" class="form-control ckeditor"
                    id='descriptionId'>{{$level->description_telc_ar}}</textarea>
                </div>
                <div class="form-group col-md-12 col-sm-6 paragraph-hidden">
                  <label>description telc en</label>
                  <textarea name="description_telc_en" cols="20" rows="2" class="form-control ckeditor"
                    id='descriptionId'>{{$level->description_telc_en}}</textarea>
                </div>
                <div class="form-group col-md-12 col-sm-6 paragraph-hidden">
                  <label>description telc fr</label>
                  <textarea name="description_telc_fr" cols="20" rows="2" class="form-control ckeditor"
                    id='descriptionId'>{{$level->description_telc_fr}}</textarea>
                </div>
                <div class="form-group col-md-12 col-sm-6 paragraph-hidden">
                ...
                <div class="col-12 col-sm-3">
                  <div class="form-group">
                    ...
                    <img class="avatar-img" src="{{asset('img/goethe/'.$level->goethe1) }}" height=" 63px"
                      width=" 60px">
                ...
                <div class="col-12 col-sm-2">
                  <div class="form-group">
                    ...
                    <img class="avatar-img" src="{{asset('img/goethe/'.$level->goethe2) }}" height=" 63px"
                      width=" 60px">
                ...
                <div class="col-12 col-sm-2">
                  <div class="form-group">
                    ...
                    <img class="avatar-img" src="{{asset('img/goethe/'.$level->goethe3) }}" height=" 63px"
                      width=" 60px">
                ...
                <div class="col-12 col-sm-2">
                  <div class="form-group">
                    ...
                    <img class="avatar-img" src="{{asset('img/goethe/'.$level->goethe4) }}" height=" 63px"
                      width=" 60px">
