    ...
    <div class="content-header row">
                    ...
                    <div class="content-header-right col-md-6 col-12">
                      <div class="dropdown float-md-right">
                           <a href="{{route('questions.create')}}"  class="btn btn-primary float-right mt-2"> Add Questions </a>
                      </div>
                    </div>
                    ...
                    <table id="table" class="table table-bordered">
                      ...
                      <tbody id="tablecontents">
                          ...
                          <tr class="row1" data-id="{{ $_item->id }}">
                              ...
                              <td class="col-sm-2">
                                  @if($_item->file)
                                      <audio controls class="align-items-center ">
                                          <source src="{{asset('img/questions-file/'.$_item->file) }}" type="audio/ogg">
                                          <source src="{{asset('img/questions-file/'.$_item->file) }}" type="audio/mpeg">
