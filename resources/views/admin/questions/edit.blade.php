            ...
            <form  method="post"  action="{{route('questions.update',$question->id)}}" enctype="multipart/form-data">
              ...
              <div class="row form-row">
                  ...
                  <div class="form-group">
                    ...
                    <select name="exam_id" required class="form-control formselect" >
                      ...
                      @foreach ($exams as $_item)
                       ...
                       <option value="{{$_item->id}}" {{ $question->exam_id == $_item->id ? "selected" : "" }}>{{$_item->name}}
                                                </option>
                      @endforeach
                    </select>
                    @error('exam_id')
                ...
                <div class="form-group col-md-12 col-sm-6 paragraph-hidden">
                  ...
                  <textarea name="paragraph"  cols="20" rows="1"  class="form-control ckeditor" id='paragraphid'>{{$question->paragraph}}</textarea>
                  @error('paragraph')
                  <span class="text-danger">{{$message}}</span>
                  @enderror
                ...
                <div class="form-group col-md-12 col-sm-6 ">
                  ...
                  <textarea name="bio"  cols="20" rows="1"  class="form-control ckeditor" id='bioId'>{{$question->bio}}</textarea>
                  @error('bio')
                  <span class="text-danger">{{$message}}</span>
                  @enderror
