              ...
              <div class="card">
                ...
                <div class="card-content collpase show">
                  <div class="card-body">
			        ...
			        <form  method="post"  action="{{route('quizes.update',$quize->id)}}" enctype="multipart/form-data">
                        @csrf
                        @method('put')
                            <div class="row form-row">
								...
								<div class="col-md-6 col-sm-6">
									...
									<input type="text" name="expected_answer" class="form-control expectedAnswerId" value="{{$quize->expected_answer}}">
