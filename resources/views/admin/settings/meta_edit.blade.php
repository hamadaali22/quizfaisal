            ...
            <div class="card">
                ...
                <div class="card-content collapse show">
                    <div class="card-body card-dashboard">
                        ...
                        <div class="card-body">
                            <h3 class="content-header-title mb-0 d-inline-block">{{$meta_pages->type}} page meta</h3>
                            <hr><br><br>
                            <form action="{{url('admin/meta-pages-update')}}" method="POST" name="le_form"
                                enctype="multipart/form-data">
                                @csrf
                                <input type="hidden" name="type" value="{{$meta_pages->type}}">
                                ...
                                <div class="row g-3 pt-3">
                                    <div class="col">
                                        ...
                                        <textarea name="desc_fr" cols="7" rows="3"
                                            class="form-control ">{{$meta_pages->desc_fr}}</textarea>
                                    </div>

                                    <div class="col">
                                        <label class="form-label">desc es</label>
                                        <textarea name="desc_es" cols="7" rows="3"
                                            class="form-control ">{{$meta_pages->desc_es}}</textarea>
                                    </div>
                                </div><br>
