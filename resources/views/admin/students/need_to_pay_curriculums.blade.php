              ...
              <div class="card">
				...
				<td>
                    <div class="status-toggle">
                        <input type="checkbox" data-id="{{ $_item->id }}" name="status_teacher"  class="status-switch" {{ $_item->status_teacher == 1 ? 'checked' : '' }}>
                    </div>
                </td>
 ...
 <script>
        ...
        $(document).ready(function(){
          $('.status-switch').change(function () {
            let status_teacher = $(this).prop('checked') === true ? 1 : 2;
            let userId = $(this).data('id');
            $.ajax({
                type: "GET",
                dataType: "json",
                url: '{{ route('students.remove-subscription-curriculums') }}',
                data: {'status_teacher': status_teacher, 'user_id': userId},
