      ...
      <div class="card">
        ...
        <div class="card-content collpase show">
          ...
          <div class="card-body">
            ...
            <form action="{{route('subexercises.store')}}" method="POST" name="le_form" enctype="multipart/form-data">
              @csrf
              <input type="hidden" name="exercise_id" class="form-control" value="{{$id}}">
