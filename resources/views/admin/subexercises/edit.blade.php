...
<section id="basic-form-layouts">
      ...
      <div class="card">
        ...
        <div class="card-content collpase show">
          ...
          <div class="card-body">
            ...
            <form method="post" action=" {{route('subexercises.update',$subexercise->id)}}"
                ...
                <div class="row form-row col-md-12">
                  <div class="form-group col-md-4 col-sm-6">
                    ...
                    <select name="answer_type" class="form-control formselect answerTypeId" id="answerType1"
                      ...
                      <option value="multiple_choice" {{ $subexercise->answer_type == 'multiple_choice' ? "selected" :
                        "" }}>Multiple Choice</option>
                      <option value="true_false" {{ $subexercise->answer_type == 'true_false' ? "selected" : "" }}> true
                        or false</option>
                      <option value="complete" {{ $subexercise->answer_type == 'complete' ? "selected" : "" }}>complete
                      </option>
                  ...
                  <div class="form-group col-md-4 col-sm-6 is_multy-hidden1" id="is_multy-hidden1">
                    ...
                    <select name="is_multy" class="form-control formselect" id="isMulty1"
                      ...
                      <option value="" selected>Select</option>
                      <option value="text" {{ $subexercise->is_multy == 'text' ? "selected" : "" }}>text</option>
                      <option value="image" {{ $subexercise->is_multy == 'image' ? "selected" : "" }}>image</option>
                    </select>
                  ...
                  <div class="form-group col-md-4 col-sm-6 is_complete_hidden1" id="is_complete_hidden1">
                    ...
                    <select name="is_complete" class="form-control formselect" id="isComplete1"
                      ...
                      <option value="" selected>Select</option>
                      <option value="number" {{ $subexercise->is_complete == 'number' ? "selected" : "" }}>number
                      </option>
                      <option value="text" {{ $subexercise->is_complete == 'text' ? "selected" : "" }}>text</option>
                      <option value="write" {{ $subexercise->is_complete == 'write' ? "selected" : "" }}>write</option>
                    </select>
                    <span id="isMultyError" style="color: red;"></span>
                  </div>
                  <div class="col-md-4 col-sm-6">
                    <div class="form-group">
                      <label>Title </label>
                      <input type="text" name="title" class="form-control titleId" value="{{$subexercise->title}}">
                  ...
                  <div class="form-group col-md-4 col-sm-6 answer-location">
                    ...
                    <select name="answer_location" class="form-control formselec">
                      <option value="" selected>Select</option>
                      <option value="beginning" {{ $subexercise->answer_location == 'beginning' ? "selected" : ""
                        }}>beginning</option>
                      <option value="middle" {{ $subexercise->answer_location == 'middle' ? "selected" : "" }}>middle
                      </option>
                      <option value="end" {{ $subexercise->answer_location == 'end' ? "selected" : "" }}>end</option>
                    </select>
                    <span id="isMultyError" style="color: red;"></span>
                  </div>
                  <div class="col-md-4 col-sm-6">
                    <div class="form-group">
                      ...
                      <input type="text" name="expected_answer" class="form-control expectedAnswerId"
                        value="{{$subexercise->expected_answer}}">
                      <span id="expectedAnswerError" style="color: red;"></span>
                    </div>
                  </div>
                  <div class="form-group col-md-6 col-sm-6 ">
                    <img class="avatar-img" src="{{asset('img/banner/'.$subexercise->bannar) }}" width="90px">
  ...
  @if($subexercise->answer)
  <input type="hidden" id="answer-one" value="{{$subexercise->answer->one}}">
  <input type="hidden" id="answer-two" value="{{$subexercise->answer->two}}">
  <input type="hidden" id="answer-three" value="{{$subexercise->answer->three}}">
  <input type="hidden" id="answer-four" value="{{$subexercise->answer->four}}">
  <input type="hidden" id="answer-five" value="{{$subexercise->answer->five}}">
  <input type="hidden" id="answer-six" value="{{$subexercise->answer->six}}">
  <input type="hidden" id="answer-seven" value="{{$subexercise->answer->seven}}">
  <input type="hidden" id="answer-eight" value="{{$subexercise->answer->eight}}">
  <input type="hidden" id="answer-nine" value="{{$subexercise->answer->nine}}">
  <input type="hidden" id="answer-ten" value="{{$subexercise->answer->ten}}">

  <input type="hidden" id="answer-eleven" value="{{$subexercise->answer->eleven}}">
  <input type="hidden" id="answer-twelve" value="{{$subexercise->answer->twelve}}">
  <input type="hidden" id="answer-thirteen" value="{{$subexercise->answer->thirteen}}">
  <input type="hidden" id="answer-fourteen" value="{{$subexercise->answer->fourteen}}">
  <input type="hidden" id="answer-fifteen" value="{{$subexercise->answer->fifteen}}">
  <input type="hidden" id="answer-sixteen" value="{{$subexercise->answer->sixteen}}">


  @endif

  @if($subexercise->expected_write_answer)
  <input type="hidden" id="answer-expected-one" value="{{$subexercise->expected_write_answer->one}}">
  <input type="hidden" id="answer-expected-two" value="{{$subexercise->expected_write_answer->two}}">
  <input type="hidden" id="answer-expected-three" value="{{$subexercise->expected_write_answer->three}}">
  <input type="hidden" id="answer-expected-four" value="{{$subexercise->expected_write_answer->four}}">
  <input type="hidden" id="answer-expected-five" value="{{$subexercise->expected_write_answer->five}}">
  <input type="hidden" id="answer-expected-six" value="{{$subexercise->expected_write_answer->six}}">
  @endif
</section>
<!-- <?php
