<div class="row education-cont complete-text-answer1" id="text-answer1"
    style="background-color: #fff;border-bottom-color: red;padding: 10px;    margin: 24px;">
    ...
    <div class="col-md-2 col-sm-6 second-choice-hidden">
        <div class="form-group">
            <label>five</label>
            <input type="text" name="five" class="form-control titleId" value="{{$complete_n_five}}">
            <span id="titleError" style="color: red;"></span>
        </div>
    </div>
    <div class="col-md-2 col-sm-6 second-choice-hidden">
