      ...
      <div class="card">
        ...
        <div class="card-content collpase show">
          ...
          <div class="card-body">
            ...
            <form  method="post" action=" {{route('subquestions.update',$subquestion->id)}}" enctype="multipart/form-data">
              @csrf
              @method('put')
                    ...
                    <div class="row form-row col-md-12">
                        ...
                        <div class="form-group col-md-4 col-sm-6">
                          ...
                          onchange="answerType('answerType1','is_multy-hidden1','is_complete_hidden1','addanswer1')">
                              ...
                              <option value="multiple_choice" {{ $subquestion->answer_type  == 'multiple_choice' ? "selected" : "" }}>Multiple Choice</option>
                              <option value="true_false" {{ $subquestion->answer_type  == 'true_false' ? "selected" : "" }}> true or false</option>
                              <option value="complete" {{ $subquestion->answer_type  == 'complete' ? "selected" : "" }}>complete</option>
                        ...
                        <div class="col-md-4 col-sm-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="expected_answer" class="form-control expectedAnswerId" value="{{$subquestion->expected_answer}}">
...
$('.complete-answer1').hide();
  ...
  if(answer_type =='multiple_choice'){
      ...
      if (is_multy=='text') {
        $('.text-answer1').show();
        $('#addanswer1').append(`@include('admin.subquestions.form-multiple-text-answer-edit',['first_choice' => '${first_choice}', 'second_choice' => '${second_choice}','third_choice' => '${third_choice}'
                            ])`);
      }
      if (is_multy=='image') {
        $('.text-answer1').show();
        $('#addanswer1').append(`@include('admin.subquestions.form-multiple-image-answer-edit',['image_a' => '${image_a}', 
                              'image_b' => '${image_b}'
                            ])`);
      }
  }
...
function showTextImageAnswer(answer_typeid,addanswer){
  ...
  if(answer_val.value == "text"){
    $('#'+addanswer)..append(`@include('admin.subquestions.form-multiple-text-answer-edit',['first_choice' => '${first_choice}','second_choice' => '${second_choice}','third_choice' => '${third_choice}'
                            ])`);
  }
