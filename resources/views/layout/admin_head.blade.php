  ...
  rel="stylesheet">
   ...
   <link rel="stylesheet" href="{{asset('admin/css/core/menu/menu-types/vertical-menu-modern.css')}}">
   ...
   <link rel="stylesheet" href="{{asset('admin/assets/css/style.css')}}">
    @if(Route::is(['admin-login','register','forgot-password','lock-screen','error-404','error-500']))
      ...
      <link rel="stylesheet" href="{{asset('admin/css/pages/login-register.css')}}">
    @endif
